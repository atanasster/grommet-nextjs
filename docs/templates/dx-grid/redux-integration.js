...
initialValues.tasks = ({ random }) => generateRows({ columnValues: employeeTaskValues, length: Math.floor(random() * 3) + 4, random, });
...
const createGridAction = (partialStateName, partialStateValue) => ({
